...
texto = """<div align="{align}">
  ...
  <br>
	...
	<a href="{link}" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
		<img src="{url_foto}" alt="{alt_foto}" style="width: 120px; height: 120px;" width="120" height="120">
	</a>
...
personas = [
    ...
    },
    {
        "nombre": "Carole",
        "Persona_y_título": {
            "Spanish": "Carole Van Rijswijck, Junior Sales and Rentals.",
            "English": "Carole Van Rijswijck, Junior Sales and Rentals.",
            "Italian": "Carole Van Rijswijck, Junior Sales and Rentals.",
        },
        "sedes": ["Ibiza"],
        "url_foto": "https://media.egorealestate.com/ORIGINAL/9ea7c188-ab24-48df-b761-b289b04a679d.webp",
        "alt_foto": {
            "Spanish": "Foto retrato de Alquileres y ventas",
            "English": "Photo portrait of Alquileres y ventas",
            "Italian": "Photo portrait of Alquileres y ventas",
        },
        "email": {
            "Ibiza": "carole@ibizavende.com",
            "Madrid": "carole@madridvende.com",
        },
        "tel_1": "660",
        "tel_2": "131",
        "tel_3": "164",
        ...
        for entorno in entornos:
            for idioma in idiomas:
                ...
                keys = {
                    ...
                    "Persona_y_título": persona["Persona_y_título"][idioma],
                    ...
                    "url_foto": persona["url_foto"]
                        if "url_foto" in persona
                        else f"http://media.ibizavende.com/fotos/firma_email/{persona['nombre_foto']}",
